...
This vignette summarizes functions of API package that gets connected with 3 APIs and gives examples on how to use them.
...
{
  #placename="museums in stockholm"
...
> "More to know how to render map outputs"
